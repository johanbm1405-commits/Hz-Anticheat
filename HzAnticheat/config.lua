--[[≺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━≻--                                                                                                                                                                                                                                                   
 ...
 |_| |_/____|    /_/   \_\_| |_|\__|_|\___|_| |_|\___|\__,_|\__|                                  
                                                                                                  
           Desarrollado por HZ - CodigosParaJuegos - FiveMSoluciones                             
                                                                                                                                                                                                                                     														
≺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━≻--]]
-- DOCS: Desarrollado por HZ - CodigosParaJuegos - FiveMSoluciones
...
HzAnticheat = {}
HzAnticheat.Setup = {}
HzAnticheat.Webhooks = {}
HzAnticheat.Protection = {}

--  ______ _______ __   _ _______  ______ _______       
-- |  ____ |______ | \  | |______ |_____/ |_____| |     
-- |_____| |______ |  \_| |______ |    \_ |     | |_____
HzAnticheat.ServerName = "Nombre Server"                                                                   -- The name of the server.
HzAnticheat.DiscordLink = "#"                                                                  -- The link to your discord server.
HzAnticheat.RequireSteam = false                                                              -- Just requires players that want to join your server to have steam open and logged in as well u must have a valid steam api key for this option read more in docs
HzAnticheat.IdentifierCheck = true                                                            -- Checks when player connects if his identifiers are valid. if not it won't let him join the server.
HzAnticheat.Debug = false 																      -- Enables debug mode, this will print debug messages in the console.
...
-- Este sistema es integrado de FiveM y no fue creado por el equipo HZ...
...
-- 2) Enable the option below ( set HzAnticheat.AutoConfig to true and not false as follows 'HzAnticheat.AutoConfig = true' )
...
HzAnticheat.BanTimes = { -- Preset ban times, preset name can be used in the protections.
	["Ban"] = 2147483647, -- Perm
	["Kick"] = -1,        -- Kick
	["Warn"] = 0,         -- Warn
}
...
HzAnticheat.OCR = { -- Words on scrren that will get player banned
...
HzAnticheat.Weapons = { -- Add all your weapons to here most of the weapons should arlready be here make sure u added all of them if you are using qbcore if not u can delete this
...
HzAnticheat.Webhooks.BlacklistedExplosions = ""  -- Takes action if an explosion with the id got detected.
HzAnticheat.Protection.BlacklistedExplosions = {
...
HzAnticheat.Webhooks.BlacklistedCommands = ""
HzAnticheat.Protection.BlacklistedCommands = { -- Takes action if a blacklisted command is registered.
...
HzAnticheat.Webhooks.BlacklistedSprites = ""
HzAnticheat.Protection.BlacklistedSprites = { -- Takes action if a blacklisted sprite is detected.
...
HzAnticheat.Webhooks.BlacklistedAnimDicts = ""
HzAnticheat.Protection.BlacklistedAnimDicts = { -- Takes action if a blacklisted anim dict got loaded.
	{ dict = "rcmjosh2",       time = "Ban", webhook = "" },
	{ dict = "rcmpaparazzo_2", time = "Ban", webhook = "" },
}

HzAnticheat.Webhooks.BlacklistedWeapons = ""
HzAnticheat.Protection.BlacklistedWeapons = { -- Weapons Names can be found here: https://gtahash.ru/weapons/
...
HzAnticheat.Webhooks.BlacklistedVehicles = ""
HzAnticheat.Protection.BlacklistedVehicles = { -- Vehicles List can be found here: https://wiki.rage.mp/index.php?title=Vehicles
...
HzAnticheat.Protection.BlacklistedPeds = { -- Add blacklisted ped models here
...
HzAnticheat.Webhooks.BlacklistedObjects = ""
HzAnticheat.Protection.BlacklistedObjects = {
