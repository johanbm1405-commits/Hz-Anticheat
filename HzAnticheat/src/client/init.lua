...
function ClientInit.initialize()
    ...
    logger.info("==============================================")
    logger.info("HzAnticheat Client v1.2.1 initializing...")
    ...
    Citizen.CreateThread(function()
        Wait(2000) 
        TriggerServerEvent("HzAnticheat:CheckWhitelist")
    end)
    ...
    RegisterNetEvent("HzAnticheat:UpdateDebugMode", function(enabled)
        local logger = require("client/core/client_logger")
