    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if GetUsingseethrough() then                
                TriggerServerEvent("HzAnticheat:Server:Methods:PunishPlayer", nil, "Anti Thermal Vision", webhook, time)
            end
            
            if GetUsingnightvision() then
                TriggerServerEvent("HzAnticheat:Server:Methods:PunishPlayer", nil, "Anti Night Vision", webhook, time)
            end
