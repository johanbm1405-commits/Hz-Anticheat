...
function ClientLogger.initialize(config)
    ...
    RegisterNetEvent("HzAnticheat:UpdateDebugMode")
    AddEventHandler("HzAnticheat:UpdateDebugMode", function(enabled)
...
function ClientLogger.send_to_server(level, message)
    if level == "ERROR" or level == "FATAL" then
        ...
        TriggerServerEvent("HzAnticheat:ClientLog", level, message)
    end
end
...
function ClientLogger.warn(message, ...)
    ...
    if #message < 100 then 
        TriggerServerEvent("HzAnticheat:ForwardLog", "WARN", message)
    end
end
...
function ClientLogger.error(message, ...)
    ...
    TriggerServerEvent("HzAnticheat:ForwardLog", "ERROR", message)
end
...
function ClientLogger.fatal(message, ...)
    ...
    TriggerServerEvent("HzAnticheat:ForwardLog", "FATAL", message)
end
